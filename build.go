...
func buildDeb() {
	...
	files := []archiveFile{
		...
		{src: "etc/linux-systemd/system/syncthing@.service", dst:"deb/etc/systemd/system/syncthing@.service", perm:0755},
		{src: "etc/linux-systemd/user/syncthing.service", dst:"deb/etc/systemd/user/syncthing.service", perm:0755},
	}
