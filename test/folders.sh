...
cat <<EOT
    <folder id="$id" label="" path="$id?maxsize=1000&seed=$id" type="sendreceive" rescanIntervalS="86400" fsWatcherEnabled="false" fsWatcherDelayS="10" ignorePerms="false" autoNormalize="true">
