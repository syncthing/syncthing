...
func ldbWithAllFolderTruncated(db *leveldb.DB, folder []byte, fn func(device []byte, f protocol.FileInfo) bool) {
	runtime.GC()
...
func ldbGetGlobal(db *leveldb.DB, folder, file []byte, truncate bool) (protocol.FileInfo, bool) {
