...
func (*DatabaseRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_92baeb38697d10dd, []int{0}
}
...
func (*ReplicationRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_92baeb38697d10dd, []int{1}
}
...
func (*DatabaseAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_92baeb38697d10dd, []int{2}
}
...
func init() { proto.RegisterFile("database.proto", fileDescriptor_database_92baeb38697d10dd) }

var fileDescriptor_database_92baeb38697d10dd = []byte{
