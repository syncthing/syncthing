...
func (c internalConn) LogValue() slog.Value {
	return slog.GroupValue(slog.String("local", c.LocalAddr().String()), slog.String("remote", c.RemoteAddr().String()), slog.String("type", c.Type()), slog.String("crypto", c.Crypto()), slog.Int("prio", c.Priority()), slog.String("id", c.ConnectionID()))
}
