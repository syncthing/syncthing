...
func setupSendReceiveFolder(t testing.TB, files ...protocol.FileInfo) (*model, *sendReceiveFolder) {
	w := createTmpWrapper(defaultCfg)
	model := newModel(t, w, myID, "syncthing", "dev", db.NewLowlevel(backend.OpenMemory()), nil)
