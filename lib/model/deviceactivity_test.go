...
func TestDeviceActivity(t *testing.T) {
	n0 := AvailabilityInfo{protocol.DeviceID([32]byte{1, 2, 3, 4}), 0}
	n1 := AvailabilityInfo{protocol.DeviceID([32]byte{5, 6, 7, 8}), 1}
	n2 := AvailabilityInfo{protocol.DeviceID([32]byte{9, 10, 11, 12}), 0}
	devices := []AvailabilityInfo{n0, n1, n2}
