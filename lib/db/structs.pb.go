...
// BlockListKeyOnly is used to unly unmarshal the block list key from a FileInfo
type BlockListKeyOnly struct {
	BlockListKey []byte `protobuf:"bytes,1001,opt,name=block_list_key,json=blockListKey,proto3" json:"block_list_key,omitempty"`
}

func (m *BlockListKeyOnly) Reset()         { *m = BlockListKeyOnly{} }
func (m *BlockListKeyOnly) String() string { return proto.CompactTextString(m) }
func (*BlockListKeyOnly) ProtoMessage()    {}
func (*BlockListKeyOnly) Descriptor() ([]byte, []int) {
	return fileDescriptor_e774e8f5f348d14d, []int{4}
}
func (m *BlockListKeyOnly) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BlockListKeyOnly) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BlockListKeyOnly.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BlockListKeyOnly) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BlockListKeyOnly.Merge(m, src)
}
func (m *BlockListKeyOnly) XXX_Size() int {
	return m.ProtoSize()
}
func (m *BlockListKeyOnly) XXX_DiscardUnknown() {
	xxx_messageInfo_BlockListKeyOnly.DiscardUnknown(m)
}

var xxx_messageInfo_BlockListKeyOnly proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*BlockListKeyOnly)(nil), "db.BlockListKeyOnly")
...
var fileDescriptor_e774e8f5f348d14d = []byte{
	...
	,
}
...
func (m *BlockListKeyOnly) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BlockListKeyOnly) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BlockListKeyOnly) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.BlockListKey) > 0 {
		...
		i = encodeVarintStructs(dAtA, i, uint64(len(m.BlockListKey)))
		i--
		dAtA[i] = 0x3e
		i--
		dAtA[i] = 0xca
...
func (m *BlockListKeyOnly) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BlockListKeyOnly) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BlockListKeyOnly: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BlockListKeyOnly: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1001:
			if wireType != 2 {
