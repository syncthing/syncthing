...
func (infiniteFS) PlatformData(_ string, _ fs.XattrFilter) (protocol.PlatformData, error) {
...
func (singleFileFS) PlatformData(_ string, _ fs.XattrFilter) (protocol.PlatformData, error) {
	return protocol.PlatformData{}, nil
}
