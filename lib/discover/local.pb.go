...
func (*Announce) Descriptor() ([]byte, []int) {
	return fileDescriptor_local_b5ff1904a14cb048, []int{0}
}
...
func init() { proto.RegisterFile("local.proto", fileDescriptor_local_b5ff1904a14cb048) }

var fileDescriptor_local_b5ff1904a14cb048 = []byte{
