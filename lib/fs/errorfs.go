...
func (fs *errorFilesystem) GetXattr(name string, xattrFilter StringFilter) ([]protocol.Xattr, error) {
	return nil, fs.err
}
...
func (fs *errorFilesystem) PlatformData(name string, xattrFilter StringFilter) (protocol.PlatformData, error) {
