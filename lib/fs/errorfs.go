...
func (fs *errorFilesystem) GetAttributes(name string) (uint32, error)                    { return 0, fs.err }
func (fs *errorFilesystem) SetAttributes(name string, f_attrs uint32, mask uint32) error { return fs.err }
