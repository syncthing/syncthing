...
type OptionsConfiguration struct {
	...
	CREnabled               bool     `xml:"crashReportingEnabled" json:"crashReportingEnabled" default:"true" restart:"true"` // Read in the monitor, and monitor only re-reads this on restart of child
