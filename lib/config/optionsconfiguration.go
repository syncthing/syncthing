...
type OptionsConfiguration struct {
	...
	MaxScheduledSendKbps     int      `xml:"maxScheduledSendKbps" json:"maxScheduledSendKbps" default:"100"`
	MaxScheduledRecvKbps     int      `xml:"maxScheduledRecvKbps" json:"maxScheduledRecvKbps" default:"100"`
	ScheduledRatesEnabled    bool     `xml:"scheduledRatesEnabled" json:"scheduledRatesEnabled" default:"false"`
	ScheduledRatesFromHour   int      `xml:"scheduledRatesFromHour" json:"scheduledRatesFromHour" default:"0"`
	ScheduledRatesFromMinute int      `xml:"scheduledRatesFromMinute" json:"scheduledRatesFromMinute" default:"0"`
	ScheduledRatesToHour     int      `xml:"scheduledRatesToHour" json:"scheduledRatesToHour" default:"23"`
	ScheduledRatesToMinute   int      `xml:"scheduledRatesToMinute" json:"scheduledRatesToMinute" default:"59"`
