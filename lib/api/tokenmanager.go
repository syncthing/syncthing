...
func newTokenManager(key string, miscDB *kv.Typed, lifetime time.Duration, maxItems int) *tokenManager {
...
func newTokenCookieManager(shortID string, guiCfg config.GUIConfiguration, evLogger events.Logger, miscDB *kv.Typed) *tokenCookieManager {
