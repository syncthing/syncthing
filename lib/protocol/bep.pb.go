...
type FileInfo struct {
	...
	// The list of extended attributes. This is a sorted list of Xattr
	// entries, with each Xattr operating_system + name value being unique.
	// We can view this as a map of {operating_system, name} -> value.
	ExtendedAttributes []Xattr `protobuf:"bytes,20,rep,name=extended_attributes,json=extendedAttributes,proto3" json:"extendedAttributes" xml:"extendedAttribute"`
...
type Xattr struct {
	OperatingSystem OS     `protobuf:"varint,1,opt,name=operating_system,json=operatingSystem,proto3,enum=protocol.OS" json:"operatingSystem" xml:"operatingSystem"`
	Name            string `protobuf:"bytes,2,opt,name=name,proto3" json:"name" xml:"name"`
	Value           []byte `protobuf:"bytes,3,opt,name=value,proto3" json:"value" xml:"value"`
}
...
var fileDescriptor_311ef540e10d9705 = []byte{
	...
	,
}
...
func (m *FileInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExtendedAttributes) > 0 {
		for iNdEx := len(m.ExtendedAttributes) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ExtendedAttributes[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Xattr) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OperatingSystem != 0 {
		i = encodeVarintBep(dAtA, i, uint64(m.OperatingSystem))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *FileInfo) ProtoSize() (n int) {
	...
	if len(m.ExtendedAttributes) > 0 {
		for _, e := range m.ExtendedAttributes {
			l = e.ProtoSize()
			n += 2 + l + sovBep(uint64(l))
		}
	}
...
func (m *Xattr) ProtoSize() (n int) {
	...
	_ = l
	if m.OperatingSystem != 0 {
		n += 1 + sovBep(uint64(m.OperatingSystem))
	}
	l = len(m.Name)
	if l > 0 {
		n += 1 + l + sovBep(uint64(l))
...
func (m *FileInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			...
			m.ExtendedAttributes = append(m.ExtendedAttributes, Xattr{})
			if err := m.ExtendedAttributes[len(m.ExtendedAttributes)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 1000:
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OperatingSystem |= OS(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
