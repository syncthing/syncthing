...
func (*TestOldDeviceID) Descriptor() ([]byte, []int) {
	return fileDescriptor_deviceid_test_c8cd7ca42e16b7c6, []int{0}
}
...
func (*TestNewDeviceID) Descriptor() ([]byte, []int) {
	return fileDescriptor_deviceid_test_c8cd7ca42e16b7c6, []int{1}
}
...
func init() { proto.RegisterFile("deviceid_test.proto", fileDescriptor_deviceid_test_c8cd7ca42e16b7c6) }

var fileDescriptor_deviceid_test_c8cd7ca42e16b7c6 = []byte{
